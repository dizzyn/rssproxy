...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = function (_React$Component) {
	    ...
	    _createClass(List, [{
	        key: 'parseRSSDesc',
	        value: function parseRSSDesc(description) {
	        ...
	        key: 'httpGet',
	        value: function httpGet(url, success, error) {
	        ...
	        value: function componentWillMount() {
	            ...
	            this.httpGet('json', function (value) {
	        ...
	        value: function render() {
	            ...
	            if (!this.state || !this.state.items) {
	                ...
	                for (var i = 0; i < this.state.items.length; i++) {
	                    ...
	                    itemComps.push(_react2.default.createElement(_Item2.default, { key: "x" + i, item: item }));
	                }

	                return _react2.default.createElement(
	                    'ul',
	                    { className: 'rssItems', style: { margin: 0, padding: 0, maxWidth: "500px" } },
	                    itemComps
	                );
	            }
	        }
	...
	var Item = function (_React$Component) {
	    ...
	    _createClass(Item, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "li",
	                { style: { marginTop: "15px", listStyleType: "none", padding: 0 } },
	                _react2.default.createElement("img", { src: this.props.item.img, style: { float: "left", width: "50%" } }),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            _react2.default.createElement("iframe", { src: fcbLink,
	                                style: {
	                                    border: "none",
	                                    overflow: "hidden",
	                                    width: "100%",
